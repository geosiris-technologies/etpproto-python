...
from etptypes.energistics.etp.v12.protocol.dataspace_osdu.copy_dataspaces_content import (
    CopyDataspacesContent,
)
from etptypes.energistics.etp.v12.protocol.dataspace_osdu.copy_dataspaces_content_response import (
    CopyDataspacesContentResponse,
)
from etptypes.energistics.etp.v12.protocol.dataspace_osdu.copy_to_dataspace import (
    CopyToDataspace,
)
from etptypes.energistics.etp.v12.protocol.dataspace_osdu.copy_to_dataspace_response import (
    CopyToDataspaceResponse,
)
from etptypes.energistics.etp.v12.protocol.dataspace_osdu.get_dataspace_info import (
    GetDataspaceInfo,
)
from etptypes.energistics.etp.v12.protocol.dataspace_osdu.get_dataspace_info_response import (
    GetDataspaceInfoResponse,
)
from etptypes.energistics.etp.v12.protocol.dataspace_osdu.lock_dataspaces import (
    LockDataspaces,
)
from etptypes.energistics.etp.v12.protocol.dataspace_osdu.lock_dataspaces_response import (
